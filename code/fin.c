...
int finition(){
    ...
    map_fin = load_bitmap("D:/Jeu_Coree_2024/decor_map/Mappourallegro/map_fin.bmp",NULL);
    collision_fin = load_bitmap("D:/Jeu_Coree_2024/decor_map/Mappourallegro/collision_fin.bmp",NULL);
    ...
    Texte_fin=load_bitmap("D:/Jeu_Coree_2024/decor_map/Sprite/texte_fin.bmp",NULL);
